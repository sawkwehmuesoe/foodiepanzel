                            ...
                            <form action="{{route('cities.store')}}" method="POST">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter City Name" value="{{old('name')}}" >
                                    </div>
                        ...
                        <table id="mytable" class="table rounded shadow">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-4 text-muted text-center">{{$city->name}}</td>
                                    <td class="p-4 text-muted text-center">{{$userdata->name}}</td>
                                    <td class="p-4 text-muted text-center">{{$city->created_at->format('d M Y h:i:s')}}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$city->id}}" data-idxname="{{$city->name}}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                            ...
                            <form id="formaction" action="" method="POST">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-8 form-group">
                                        ...
                                        <input type="text" name="name" id="editname" class="form-control" placeholder="Enter City Name" value="{{old('name')}}" >
                                    </div>
