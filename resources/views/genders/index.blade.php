                            ...
                            <tbody>
                                @foreach ($genders as $idx => $gender)
                                    <tr>
                                        ...
                                        <td class="p-4 text-muted text-center">{{ $gender->name }}</td>
                                        <td class="p-4 text-muted text-center">{{ $userdata->name }}</td>
                                        <td class="p-4 text-muted text-center">
                                            {{ $gender->created_at->format('d M Y h:i:s') }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="text-danger ms-2 delete-btns"
                                                data-idx="{{ $gender->name }}"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                        <form id="formdelete-{{ $gender->name }}"
