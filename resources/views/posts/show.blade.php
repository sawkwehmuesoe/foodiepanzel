                                ...
                                <div class=" bg-white p-4 pt-5 rounded">
                                    ...
                                    <div class="detail-carts">
                                       ...
                                       <div class="d-flex justify-content-between">
                                            ...
                                            <div class="my-2">
                                                <p class="mb-2"><span class="text-muted">{{$post->created_at->format('d M Y h:i:s')}}</span></p>
                                                <p class="mb-2"><span class="text-muted">{{$post->updated_at->format('d M Y h:i:s')}}</span></p>
